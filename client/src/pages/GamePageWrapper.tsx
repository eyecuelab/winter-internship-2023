...
function GamePageWrapper(props: Props) {
  ...
  useEffect(() => {
    ...
    verticalDirBothYellowImg.src = `data:image/svg+xml;base64,${window.btoa(
      verticalDirBothYellowSvgString
    )}`;
    ...
    verticalDirBothGreyImg.src = `data:image/svg+xml;base64,${window.btoa(
      verticalDirBothGreySvgString
    )}`;
    ...
    verticalDirBottomGreyImg.src = `data:image/svg+xml;base64,${window.btoa(
      verticalDirBottomGreySvgString
    )}`;
    ...
    verticalDirTopGreyImg.src = `data:image/svg+xml;base64,${window.btoa(
      verticalDirTopGreySvgString
    )}`;
    ...
    horizontalDirBothYellowImg.src = `data:image/svg+xml;base64,${window.btoa(
      horizontalDirBothYellowSvgString
    )}`;
    ...
    horizontalDirBothGreyImg.src = `data:image/svg+xml;base64,${window.btoa(
      horizontalDirBothGreySvgString
    )}`;
    ...
    horizontalDirLeftGreyImg.src = `data:image/svg+xml;base64,${window.btoa(
      horizontalDirLeftGreySvgString
    )}`;
    ...
    horizontalDirRightGreyImg.src = `data:image/svg+xml;base64,${window.btoa(
      horizontalDirRightGreySvgString
    )}`;
  ...
  const displayWrapperContent = () => {
    ...
    if (socketId === myTeam?.playerInControl) {
      if (myGameStateWrapper.myControl === "y") {
        ...
        dirImg.setAttribute(
          "src",
          `${horizontalDirBothGreySvgRef.current?.src}`
        );
        dirImg.setAttribute("id", "my-turn");
      }
    } else {
      if (myGameStateWrapper.myControl === "y") {
        ...
        if (lastKeyState === "w") {
          dirImg.setAttribute(
            "src",
            `${verticalDirBottomGreySvgRef.current?.src}`
          );
        } else if (lastKeyState === "s") {
          dirImg.setAttribute(
            "src",
            `${verticalDirTopGreySvgRef.current?.src}`
          );
        } else {
          dirImg.setAttribute(
            "src",
            `${verticalDirBothGreySvgRef.current?.src}`
          );
        }
      } else if (myGameStateWrapper.myControl === "x") {
        dirImg.removeAttribute("id");
        ...
        if (lastKeyState === "a") {
          dirImg.setAttribute(
            "src",
            `${horizontalDirRightGreySvgRef.current?.src}`
          );
        } else if (lastKeyState === "d") {
          dirImg.setAttribute(
            "src",
            `${horizontalDirLeftGreySvgRef.current?.src}`
          );
        } else {
          dirImg.setAttribute(
            "src",
    ...
    if (scoresArr[0]) {
      ...
      liFour.appendChild(document.createTextNode(`${scoresArr[0]}`));
    }
    ...
    if (scoresArr[1]) {
      ...
      liFive.appendChild(document.createTextNode(`${scoresArr[1]}`));
    }
    if (scoresArr[1]) {
